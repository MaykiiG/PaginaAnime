    ...
    <div class="container-items">
        <div class="item">
            ...
            <div class="info-product">
                <h2>SPY x FAMYLY Tatsuya Endō Shōnen Jump</h2>
                <p class="price">$12</p>
        ...
        <div class="item">
            <figure>
                <img
                    src="img/me_divorciare.jpg"
                    alt="producto"
                />
            </figure>
            <div class="info-product">
                <h2>ME DIVORCIARE DE MI ESPOSO Shōnen Ace</h2>
                <p class="price">$20</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>HAJIMETE NO GAL Meguru Ueno  Shōnen Ace</h2>
                <p class="price">$12</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>NARUTO:NARUTO NEXT GENERATIONS</h2>
                <p class="price">$36</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            <figure>
                <img
                    src="https://otakuteca.com/images/books/cover/5ea4897424752.jpg"
                    alt="producto"
                />
            </figure>
            <div class="info-product">
                <h2>PLUNDERER Suu Minazuki Kadokawa Shōten</h2>
                <p class="price">$45</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>AKI-SORA Masahiro Itosugi Akita Shoten</h2>
                <p class="price">$25</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
