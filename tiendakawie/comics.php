...
<body>
    <header>
        <div class="cabecera">
            ...
            <div class="cabecera_logo"><img id="imgpri" src="img/anime.png" alt=""/> </div>
    ...
    <div class="container-items">
        <div class="item">
            ...
            <div class="info-product">
                <h2>FLASH VOL ( REMASTERISADO ) 1</h2>
                <p class="price">$45</p>
        ...
        <div class="item">
            ...
            <div class="info-product">
                <h2>BATMAN VS TORTUGAS NINJA VOL1</h2>
                <p class="price">$36</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>SUPERMAN VOL(EDICION LIMITADA) 1</h2>
                <p class="price">$56</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>BATMAN Y EL JOKER (EDICION LIMITADA)</h2>
                <p class="price">$39</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>SPIDERMAN MULTIVERSO(AES) PARTE 1 </h2>
                <p class="price">$45</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
        <div class="item">
            ...
            <div class="info-product">
                <h2>DOCTOR STRANGE VOL 1 (EDICION LIMITADA)</h2>
                <p class="price">$25</p>
                <button class="btn-add-cart">Añadir al carrito</button>
            </div>
        </div>
